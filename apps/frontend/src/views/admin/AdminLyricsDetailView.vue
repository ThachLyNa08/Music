  ...
  <div class="flex-1 flex flex-col bg-slate-50 relative overflow-hidden full-bleed">
    ...
    <header class="py-6 bg-white border-b border-slate-200 flex items-center justify-between px-6 shrink-0">
      ...
      <div class="flex items-center gap-3">
        <button @click="router.push('/admin/lyrics')" class="inline-flex items-center px-3 py-2 text-sm font-medium text-slate-600 bg-white border border-slate-300 rounded-lg hover:bg-slate-50 transition">
          <MfIcon name="arrow_back" size="18" class="mr-1.5" />
          Quay lại danh sách
        </button>
      </div>
    </header>
          ...
          <div class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm">
            ...
            <div class="space-y-3 mt-5 text-sm pt-4 border-t border-slate-100">
              ...
              <div class="flex justify-between items-center">
                ...
                <span v-if="currentSong.lyrics?.lyrics_status === 'synced'" class="px-2 py-0.5 rounded text-xs font-semibold bg-emerald-100 text-emerald-700">Đồng bộ</span>
                <span v-else-if="currentSong.lyrics?.lyrics_status === 'plain'" class="px-2 py-0.5 rounded text-xs font-semibold bg-blue-100 text-blue-700">Thường</span>
