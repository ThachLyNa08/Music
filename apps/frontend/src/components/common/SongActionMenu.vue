<template>
  <div v-if="show" class="fixed z-[9999] w-56 user-dropdown text-slate-300 text-sm font-medium overflow-y-auto overscroll-contain max-h-[80vh] shadow-[0_8px_40px_rgba(0,0,0,0.8)]"
