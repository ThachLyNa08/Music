  ...
  >
    ...
    <div class="flex items-center gap-2 shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
      <button
        ...
        :class="song.is_liked ? 'text-[#ec4899]' : 'text-gray-400 hover:text-white'"
        @click.stop="$emit('toggleLike', song)"
      >
        <svg viewBox="0 0 24 24" :fill="song.is_liked ? '#ec4899' : 'none'" stroke="#ec4899" stroke-width="2" class="w-5 h-5">
