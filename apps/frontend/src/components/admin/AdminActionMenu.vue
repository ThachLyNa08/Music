...
function colorClasses(action) {
  if (action.danger || action.variant === 'danger') return 'text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-500/10'
  if (action.variant === 'success') return 'text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-500/10'
  if (action.variant === 'warning') return 'text-amber-600 hover:bg-amber-50 dark:hover:bg-amber-500/10'
