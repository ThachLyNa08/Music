<template>
  <Teleport to="body">
    <div class="fixed inset-0 z-[9999] flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-3 sm:p-6" @click.self="handleClose" aria-labelledby="modal-title" role="dialog" aria-modal="true">
      <!-- Modal Panel -->
      <div class="mx-auto flex w-full max-w-2xl max-h-[calc(100vh-24px)] sm:max-h-[calc(100vh-48px)] flex-col bg-white dark:bg-bg-surface rounded-2xl shadow-2xl overflow-hidden">
        <!-- Header -->
        <header class="shrink-0 flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-bg-border bg-gray-50 dark:bg-bg-card">
