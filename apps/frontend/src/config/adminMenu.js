...
export const adminMenu = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: 'fetch-cover', label: 'Fetch cover', icon: 'add_photo_alternate', route: { name: 'AdminFetchCover' }, role: 'admin' },
      { key: 'fetch-lyrics', label: 'Fetch lyrics', icon: 'article', route: { name: 'AdminFetchLyrics' }, role: 'admin' },
      { key: 'analyze-features', label: 'Analyze features', icon: 'equalizer', route: { name: 'AdminAnalyzeFeatures' }, role: 'admin' },
      { key: 'export-report', label: 'Export report', icon: 'download', route: { name: 'AdminExportReport' }, role: 'admin' },
    ],
  },
  {
    ...
    children: [
      ...
      { key: 'model-logs', label: 'Model logs', icon: 'receipt_long', route: { name: 'AdminModelLogs' }, role: 'admin' },
      { key: 'retrain', label: 'Retrain', icon: 'model_training', route: { name: 'AdminRetrain' }, role: 'admin' },
    ],
  },
  {
    key: 'users-premium',
  ...
  },
  {
    ...
    children: [
      ...
      { key: 'audit-log', label: 'Audit log', icon: 'policy', route: { name: 'AdminAuditLog' }, role: 'admin' },
      { key: 'system-logs', label: 'System logs', icon: 'terminal', route: { name: 'AdminSystemLogs' }, role: 'admin' },
    ],
  },
]
