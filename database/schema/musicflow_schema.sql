...
) COMMENT='Dang ky Premium cua nguoi dung';


-- Giao dich thanh toan Premium
...
) COMMENT='Lich su giao dich thanh toan Premium';


-- Them FK premium_plans vao users (sau khi bang premium_plans da tao)
ALTER TABLE users
    ADD CONSTRAINT fk_user_plan
    FOREIGN KEY (premium_plan_id) REFERENCES premium_plans (id) ON DELETE SET NULL;


-- ============================================================
-- NHOM 8: AI PLAYLIST GENERATOR
-- ============================================================
...
INSERT INTO premium_plans (name, duration_days, price, features) VALUES
    ('Standard 1 tháng', 30,  59000,  '{"stem_download_limit": 10, "stem_duration_limit": null}'),
    ('Standard 3 tháng', 90,  149000, '{"stem_download_limit": 10, "stem_duration_limit": null}'),
    ('Pro 1 năm',        365, 499000, '{"stem_download_limit": null, "stem_duration_limit": null}');
